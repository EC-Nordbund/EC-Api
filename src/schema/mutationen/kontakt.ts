    ...
    resolve: handleAuth((_, args) => {
      return new Promise((resolve, reject) => {
        query(
          ...
          .then((v) => {
            query(
              `SELECT adressID FROM adressen WHERE personID = ${args.personID} AND strasse = '${args.strasse}' AND plz = '${args.plz}' AND ort = '${args.ort}'`
            )
    ...
    resolve: handleAuth((_, args) => {
      return new Promise((resolve, reject) => {
        query(
          ...
          .then((v) => {
            query(
              `SELECT eMailID FROM eMails WHERE personID = ${args.personID} AND eMail = '${args.email}'`
            )
    ...
    resolve: handleAuth((_, args) => {
      return new Promise((resolve, reject) => {
        query(
          ...
          .then((v) => {
            query(
              `SELECT telefonID FROM telefone WHERE personID = ${args.personID} AND telefon = '${args.telefon}'`
            )
