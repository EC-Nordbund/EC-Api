...
export async function erfolgMailContent(data: any): Promise<string> {
  return require('inline-css')(
    ...
    <p>
      ${
        data.status == 0
          ? 'Deine Anmeldung wurde bestätigt! Und du stehst nicht auf der Warteliste. (Beachte, dass der Hinweis zu Warteliste eine <b>unverbindliche</b> Mitteilung ist. Erst bei Erhalt der <b>Buchungsbestätigung</b> per E-Mail ist ein Platz garantiert!) Du erhälst in der Regel innerhalb von 4 Wochen den Bestätigungsbrief mit allen weiteren Informationen z.B. Anzahlung.'
